...
test("release metadata remains 0.5.4 while the README introduction stays version-independent", () => {
  ...
  assert.match(pkg.description, /TXTeditor 0\.5\.4/);
  assert.match(cargoToml, /version = "0\.5\.4"/);
  assert.match(cargoToml, /description = "TXTeditor 0\.5\.4/);
